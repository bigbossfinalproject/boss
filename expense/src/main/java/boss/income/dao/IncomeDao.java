...
public interface IncomeDao { // 소득 관련 dao 인터페이스
	...
	public String getIncomeName(String income_Name); //소득 코드를 통해 소득 이름을 불러옴(주요소득/기타소득)
	
	public int incomeCodeCount(Map<String, String> income_code);
	
	public List<IncomeOptionBean> getIncomeOptions(int root_Idn); // selectbox에 들어갈 값들을 불러옴
