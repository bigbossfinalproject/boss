...
@Controller
public class Income_gender_AnalysisController {
	...
	public ModelAndView gender_income_age(HttpServletRequest request, HttpServletResponse response){
		...
		try {
            ...
            connection.eval("saveWidget(p, file=\"C:/workspaces/finalproject/boss/src/main/webapp/resources/bigdata_html/gender_income_age.html\")");
		...
		mav.setViewName("/bigdata/total_analysis/gender_income/gender_income_age_result");
		return mav;
	}

	@RequestMapping(value="/gender_income_marry.do")
	public ModelAndView gender_income_marry(HttpServletRequest request, HttpServletResponse response){
		response.setCharacterEncoding("UTF-8");
		ModelAndView mav = new ModelAndView();
		RConnection connection = null;
		try {
            ...
            connection.eval("age_income <- bigdata %>% "
              ...
              + " summarise(mean_income = mean(income_amount))");
            connection.eval("a <- ggplot(data=age_income, aes(x=root_gender, y=mean_income, fill=root_marry))"
              + "+geom_col(position=\"dodge\")"
              + "+theme(legend.title = element_blank() ,legend.background = element_rect(fill=\"gainsboro\", color = \"black\")"		
              + "+ggtitle(\"분석 그래프\")"
              + "+xlab(\"성별\")"
              + "+ylab(\"소득\")");
            connection.eval("p <- ggplotly(a)");
            connection.eval("saveWidget(p, file=\"C:/workspaces/finalproject/boss/src/main/webapp/resources/bigdata_html/gender_income_marry.html\")");
            connection.eval("dev.off()");
        } catch (Exception e) {
            // TODO: handle exception
            System.out.println(e);
		...
		mav.setViewName("/bigdata/total_analysis/gender_income/gender_income_marry_result");
		return mav;
	}
	
	@RequestMapping(value="/gender_income_job.do")
	public ModelAndView gender_income_job(HttpServletRequest request, HttpServletResponse response){
		response.setCharacterEncoding("UTF-8");
		ModelAndView mav = new ModelAndView();
		RConnection connection = null;
		try {
            ...
            connection.eval("a <- ggplot(data=age_income, aes(x=root_gender, y=mean_income, fill=root_marry))"
              ...
              + "+ylab(\"소득\")");
            connection.eval("p <- ggplotly(a)");
            connection.eval("saveWidget(p, file=\"C:/workspaces/finalproject/boss/src/main/webapp/resources/bigdata_html/gender_income_job.html\")");
            connection.eval("dev.off()");
        } catch (Exception e) {
            // TODO: handle exception
            System.out.println(e);
		...
		mav.setViewName("/bigdata/total_analysis/gender_income/gender_income_job_result");
		return mav;
	}
	
	@RequestMapping(value="/gender_income_edu.do")
	public ModelAndView gender_income_edu(HttpServletRequest request, HttpServletResponse response){
		response.setCharacterEncoding("UTF-8");
		ModelAndView mav = new ModelAndView();
		RConnection connection = null;
		try {
            ...
            connection.eval("age_income <- bigdata %>% "
              + " filter(!is.na(income_amount)) %>% "
              + " group_by(root_edu, root_gender) %>% "
              + " summarise(mean_income = mean(income_amount))");
            connection.eval("a <- ggplot(data=age_income, aes(x=root_gender, y=mean_income, fill=root_edu))"
              + "+geom_col(position=\"dodge\")"
              + "+theme(legend.title = element_blank() ,legend.background = element_rect(fill=\"gainsboro\", color = \"black\")"		
              + "+ggtitle(\"분석 그래프\")"
              + "+xlab(\"성별\")"
              + "+ylab(\"소득\")");
            connection.eval("p <- ggplotly(a)");
            connection.eval("saveWidget(p, file=\"C:/workspaces/finalproject/boss/src/main/webapp/resources/bigdata_html/gender_income_edu.html\")");
            connection.eval("dev.off()");
        } catch (Exception e) {
            // TODO: handle exception
            System.out.println(e);
		...
		mav.setViewName("/bigdata/total_analysis/gender_income/gender_income_edu_result");
		return mav;
	}
	
	@RequestMapping(value="/gender_income_loc.do")
	public ModelAndView gender_income_loc(HttpServletRequest request, HttpServletResponse response){
		response.setCharacterEncoding("UTF-8");
		ModelAndView mav = new ModelAndView();
		RConnection connection = null;
		try {
            ...
            connection.eval("age_income <- bigdata %>% "
              ...
              + " summarise(mean_income = mean(income_amount))");
            connection.eval("a <- ggplot(data=age_income, aes(x=root_gender, y=mean_income, fill=root_loc))"
              + "+geom_col(position=\"dodge\")"
              + "+theme(legend.title = element_blank() ,legend.background = element_rect(fill=\"gainsboro\", color = \"black\")"		
              + "+ggtitle(\"분석 그래프\")"
              + "+xlab(\"성별\")"
              + "+ylab(\"소득\")");
            connection.eval("p <- ggplotly(a)");
            connection.eval("saveWidget(p, file=\"C:/workspaces/finalproject/boss/src/main/webapp/resources/bigdata_html/gender_income_loc.html\")");
            connection.eval("dev.off()");
        } catch (Exception e) {
            // TODO: handle exception
            System.out.println(e);
		...
		mav.setViewName("/bigdata/total_analysis/gender_income/gender_income_loc_result");
		return mav;
	}
