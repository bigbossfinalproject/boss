...
function getList(){
	location.href="noticeBoard.bo";
};
function goDel(bId){
	location.href="noticeBoard_delete.bo?bId=" + bId;	
};
</script>
...
<section class="container" id="container">
		    ...
		    <article class="half" id="half">
		   		 <form action="noticeBoard_modify.bo">
				        ...
				        <div class="content2">
							                    <div class="inpt2">
							                    	<textarea rows="25px" cols="100%" class="welcome" id="bContent" name="bContent">${dto.bContent}</textarea>
							                    </div>
