...
function goDel(bId){
	location.href="communiteBoard_delete.bo?bId=" + bId;	
}
		    	...
		    	<form action = "communiteBoard_modify.bo">
			        <h1>Writer : ${dto.root_Id}</h1>			       
			       	<input type="hidden" id="bId" name="bId" value="${dto.bId }">
				        ...
				        <div class="content2">
							                    <div class="inpt2">
							                    	<textarea rows="25px" cols="100%" class="welcome" id="bContent" name="bContent" value="${dto.bContent}">${dto.bContent}</textarea>
							                    </div> 
				        </div>
				        ...
				        <div class="content">
				        						...
				        						<div class="submit-wrap">
								                        <input type="button" value="list" class="submit" onclick="getList();">
							                    </div>
							                    <div class="submit-wrap">
